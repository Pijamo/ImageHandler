...
function handler(event) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (ENABLE_DEFAULT_FALLBACK_IMAGE === "Yes" &&
                !(0, helpers_1.isNullOrWhiteSpace)(DEFAULT_FALLBACK_IMAGE_BUCKET) &&
                !(0, helpers_1.isNullOrWhiteSpace)(DEFAULT_FALLBACK_IMAGE_KEY)) {
                try {
                    const defaultFallbackImage = yield s3Client
                        .getObject({
